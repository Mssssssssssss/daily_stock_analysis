...
const fieldTitleMap: Record<string, string> = {
  ...
  WECOM_STREAM_ENABLED: '企业微信长连接',
  WECOM_STREAM_CLIENT_ID: '企业微信长连接 Client ID',
  WECOM_STREAM_CLIENT_SECRET: '企业微信长连接 Client Secret',
  WECOM_STREAM_BOT_ID: '企业微信长连接 Bot ID',
...
const fieldDescriptionMap: Record<string, string> = {
  ...
  WECOM_STREAM_ENABLED: '企业微信智能机器人长连接开关；python main.py --serve 时启动后台 worker，不改变企业微信 Webhook 推送。',
  WECOM_STREAM_CLIENT_ID: '兼容旧配置的 BotID fallback；新配置优先填写 WECOM_STREAM_BOT_ID。',
  WECOM_STREAM_CLIENT_SECRET: '企业微信智能机器人长连接 Secret，用于 aibot_subscribe body.secret。',
  WECOM_STREAM_BOT_ID: '企业微信智能机器人长连接 BotID，用于 aibot_subscribe body.bot_id。',
