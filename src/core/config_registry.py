...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "WECOM_STREAM_ENABLED": {
        ...
        "description": (
            "Enable the Enterprise WeChat intelligent bot long-connection worker. "
            "It starts with python main.py --serve and does not change WECHAT_WEBHOOK_URL delivery."
        ),
        "category": "notification",
        "data_type": "boolean",
        "ui_control": "switch",
        ...
        "validation": {},
        "display_order": 11,
        "help_key": "settings.notification.WECOM_STREAM_ENABLED",
        "examples": [
    ...
    "WECOM_STREAM_CLIENT_ID": {
        ...
        "description": "Legacy Enterprise WeChat long-connection BotID fallback. Prefer WECOM_STREAM_BOT_ID for new configs.",
        "category": "notification",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
        ...
        "validation": {},
        "display_order": 12,
        "help_key": "settings.notification.WECOM_STREAM_CLIENT_ID",
        "examples": ["WECOM_STREAM_CLIENT_ID=your_wecom_stream_bot_id"],
        "docs": [
            {
                "label": "完整指南：通知渠道配置",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#通知渠道详细配置",
    ...
    "WECOM_STREAM_CLIENT_SECRET": {
        ...
        "description": "Enterprise WeChat intelligent bot long-connection Secret.",
        "category": "notification",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
        ...
        "validation": {},
        "display_order": 13,
        "help_key": "settings.notification.WECOM_STREAM_CLIENT_SECRET",
        "examples": ["WECOM_STREAM_CLIENT_SECRET=your_wecom_stream_client_secret"],
        "docs": [
            {
                "label": "完整指南：通知渠道配置",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#通知渠道详细配置",
    ...
    "WECOM_STREAM_BOT_ID": {
        ...
        "description": "Enterprise WeChat intelligent bot BotID used in aibot_subscribe body.bot_id.",
        "category": "notification",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 14,
        "help_key": "settings.notification.WECOM_STREAM_BOT_ID",
        "examples": ["WECOM_STREAM_BOT_ID=your_wecom_stream_bot_id"],
        "docs": [
            {
                "label": "完整指南：通知渠道配置",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#通知渠道详细配置",
